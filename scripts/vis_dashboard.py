...
ax.scatter(B0101["timestamp"], B0101["value"], label="Stabilizor")
ax.scatter(B0201["timestamp"], B0201["value"], label="Evaporator")
...
ax.scatter(B0102["timestamp"], B0102["value"], label="Stabilizor")
ax.scatter(B0202["timestamp"], B0202["value"], label="Evaporator")
ax.set_title("pH")
ax.set_ylim(0, 14)
ax.set_ylabel("pH")
ax.legend()
...
ax.scatter(B0103["timestamp"], B0103["value"], label="Stabilizor")
ax.scatter(B0203["timestamp"], B0203["value"], label="Evaporator")
...
ax.scatter(B0301["timestamp"], B0301["value"], label="upstream dehum.")
ax.scatter(B0303["timestamp"], B0301["value"], label="downstream dehum.")
...
ax.scatter(B0301["timestamp"], B0301["value_aux1"], label="upstream dehum.")
ax.scatter(B0303["timestamp"], B0301["value_aux1"], label="downstream dehum.")
ax.set_title("rel. humidity (process air)")
ax.set_ylim(15, 40)
ax.set_ylabel("T [°C]")
ax.legend()
...
ax.scatter(CPU["timestamp"], CPU["value"])
